...
allowed-tools: "Bash(node ${CLAUDE_SKILL_DIR}/../../bin/*) Bash(node */nativeui-plugin/bin/*) Read Write Edit"
---
...
node ${CLAUDE_SKILL_DIR}/../../bin/nui-test-gen.mjs project.json --platform android --out ./android-out

# iOS: a Tests/ XCTest source (+ a README on adding it to a Test target in Xcode)
node ${CLAUDE_SKILL_DIR}/../../bin/nui-test-gen.mjs project.json --platform ios --out ./ios-out

# Both at once (separate output dirs):
node ${CLAUDE_SKILL_DIR}/../../bin/nui-test-gen.mjs project.json --platform both \
