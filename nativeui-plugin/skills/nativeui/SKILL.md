...
```bash
node ${CLAUDE_SKILL_DIR}/../../bin/nui-test-gen.mjs project.json --platform both --out ./android-out --ios-out ./ios-out
```
...
`node ${CLAUDE_SKILL_DIR}/../../bin/nui-run.mjs project.json --platform both` (skill: **nativeui-run**).
