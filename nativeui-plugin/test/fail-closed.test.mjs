...
const BAD_ARGS = [
  ...
  { name: 'nui-export.mjs', args: [fixture('good-project.json')], match: /Provide --target, --all-targets, or --platform/ },
  { name: 'nui-export.mjs', args: [fixture('good-project.json'), '--platform', 'wat', '-o', '/tmp/x'], match: /Unknown NativeUI target/ },
